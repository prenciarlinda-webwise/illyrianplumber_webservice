        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="flex-1 min-w-0 max-w-3xl">
              ...
              {/* Why homeowners and landlords call */}
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Why North Brunswick homeowners and landlords call us for emergencies</h2>
              <div className="grid md:grid-cols-2 gap-4 mb-12">
                {[
                  "About 10 minute response from our East Brunswick headquarters",
                  "Live dispatcher day or night, never voicemail or a call center",
                  "Licensed NJ Master Plumbers with full insurance on every job",
                  "Upfront written pricing before any repair begins",
                  "Experienced coordinating access and billing with landlords and property managers",
                  "Permits pulled from the North Brunswick Township Construction Office when the emergency requires follow-up work",
                ].map((reason, index) => (
            ...
            <aside className="hidden lg:block lg:w-72 flex-shrink-0">
              <div className="sticky top-[6rem] space-y-6">
                <div className="bg-white rounded-xl shadow-md p-5 border-t-4 border-red-700">
                  <p className="text-lg font-bold text-gray-900 mb-1">Emergency in North Brunswick?</p>
                  <p className="text-gray-600 text-sm mb-4">About 10 minute response, 24/7.</p>
                ...
                <div className="bg-white rounded-xl shadow-md p-5">
                  ...
                  <ul className="space-y-2 text-sm">
                    <li><Link href="/services/emergency-plumbing" className="text-gray-700 hover:text-red-700 transition">24/7 Emergency Plumbing</Link></li>
