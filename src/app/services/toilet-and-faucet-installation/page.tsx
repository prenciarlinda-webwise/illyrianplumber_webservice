        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 mb-8 max-w-2xl">
              Professional installation of toilets, faucets, and bathroom fixtures. We work with all major brands and ensure proper installation for years of trouble-free use throughout East Brunswick and Middlesex County, NJ.
            </p>
