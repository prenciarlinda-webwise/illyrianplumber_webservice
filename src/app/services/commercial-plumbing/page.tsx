      ...
      <section className="relative bg-gray-900 text-white py-20 md:py-28">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <p className="text-red-400 font-semibold mb-4">Licensed Commercial Plumbers</p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Commercial Plumbing Services
            </h1>
            <p className="text-xl text-gray-200 mb-8 max-w-2xl">
              Expert commercial plumbing repair, installation, and maintenance for businesses throughout Middlesex County, NJ. From commercial kitchen buildouts to emergency pipe repairs, our licensed contractors keep your operations running without interruption.
            </p>
