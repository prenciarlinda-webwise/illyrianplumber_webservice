...
export const metadata: Metadata = {
  title: "Tankless Water Heater Installation NJ - Illyrian Group Corp",
  description: "Professional tankless water heater installation in East Brunswick, NJ. Gas & electric systems by licensed plumbers. Free estimates. Call (347) 461-4856 for expert installation.",
  keywords: [
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-200 mb-8 max-w-2xl">
              Professional tankless water heater installation by licensed NJ plumbers. Get endless hot water with expert, code-compliant installation. Free estimates with transparent, upfront pricing.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-6">
              Tankless water heaters, also known as on-demand water heaters, heat water only when you need it - eliminating the energy waste of keeping a large tank hot 24/7. For New Jersey homeowners, switching to a tankless system offers significant benefits that make it a smart long-term investment.
            </p>
            ...
            <p className="text-lg text-gray-600 mb-6">
              Every tankless water heater installation is unique. During your free assessment, we evaluate several factors to provide an accurate quote and ensure your system performs optimally.
            </p>
            ...
            <p className="text-lg text-gray-600 mb-6">
              At Illyrian Group Corp, we follow a thorough installation process to ensure your tankless water heater is installed correctly, safely, and to code. Here&apos;s what to expect when you work with us.
            </p>
            ...
            <div className="space-y-4 mb-12">
              {[
                ...
                { step: "6", title: "System Testing", desc: "We thoroughly test all connections for leaks, verify proper combustion and venting, check flow rates at multiple fixtures, and set your preferred temperature (typically 120°F for safety)." },
                { step: "7", title: "Inspection & Walkthrough", desc: "We schedule the required permit inspection and provide a complete walkthrough of your new system, including how to operate it, maintenance requirements, and warranty information." },
              ].map((item, index) => (
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              {[
                ...
                { title: "Experience You Can Trust", desc: "Serving East Brunswick and Middlesex County with professional plumbing services. We've installed hundreds of tankless systems." },
                { title: "Free Estimates, No Surprises", desc: "We provide detailed written quotes after assessing your home. You'll know exactly what's included before we start work." },
                ...
                { title: "We Handle Permits", desc: "We pull all required permits and schedule inspections. You don't have to deal with the township or worry about code compliance." },
            ...
            <div className="bg-gray-50 rounded-xl p-6 mb-12">
              ...
              <p className="text-gray-600 mb-4">We install tankless water heaters throughout Middlesex County and Central New Jersey:</p>
