...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.illyrianplumber.com/blog/how-to-descale-tankless-water-heater" },
  keywords: [
    ...
    <>
      ...
      <article className="bg-white">
        ...
        <div className="container mx-auto px-4 pt-8">
          <AuthorBio publishDate="2025-01-13" updateDate="2026-03-23" />
        </div>
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="flex-1 min-w-0 max-w-3xl">
            ...
            <div className="bg-gray-900 text-white rounded-xl p-6 mb-12 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                <p className="font-bold text-lg">Don&apos;t want to DIY?</p>
                <p className="text-gray-300 text-sm">Professional tankless maintenance and descaling service</p>
              </div>
            ...
            <div className="bg-red-700 text-white rounded-xl p-6 mb-12">
              <p className="font-bold text-lg mb-1">Don&apos;t want to DIY?</p>
              <p className="text-red-100 text-sm mb-4">Professional tankless maintenance and descaling service</p>
            ...
            <div className="border border-gray-200 rounded-xl p-6 mb-12 flex flex-col sm:flex-row items-start gap-4 hover:shadow-md transition">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mb-2">Professional water heater repair and maintenance services including tankless descaling, troubleshooting, and performance optimization.</p>
          ...
          <aside className="hidden lg:block lg:w-72 flex-shrink-0">
            <div className="sticky top-[6rem] space-y-6">
              <div className="bg-white rounded-xl shadow-md p-5 border-t-4 border-red-700">
                ...
                <p className="text-gray-600 text-sm mb-4">Professional tankless descaling and maintenance in Middlesex County.</p>
