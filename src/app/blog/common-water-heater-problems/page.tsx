            ...
            <section id="middlesex-county" className="mb-12">
              ...
              <div className="bg-red-50 border border-red-200 rounded-xl p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm text-gray-700">
                  <Link href="/service-areas/east-brunswick" className="bg-white px-3 py-2 rounded text-center hover:text-red-700 transition">East Brunswick</Link>
                  <Link href="/service-areas/edison" className="bg-white px-3 py-2 rounded text-center hover:text-red-700 transition">Edison</Link>
                  <Link href="/service-areas/sayreville" className="bg-white px-3 py-2 rounded text-center hover:text-red-700 transition">Sayreville</Link>
                  <Link href="/service-areas/old-bridge" className="bg-white px-3 py-2 rounded text-center hover:text-red-700 transition">Old Bridge</Link>
                  <Link href="/service-areas/monroe-township" className="bg-white px-3 py-2 rounded text-center hover:text-red-700 transition">Monroe Township</Link>
                  <Link href="/service-areas/south-brunswick" className="bg-white px-3 py-2 rounded text-center hover:text-red-700 transition">South Brunswick</Link>
                  <Link href="/service-areas/north-brunswick" className="bg-white px-3 py-2 rounded text-center hover:text-red-700 transition">North Brunswick</Link>
                </div>
              </div>
            </section>
