...
const blogPosts = [
  ...
  {
    title: "What Is a Plumbing Safety Inspection? (Plain-English Guide)",
    slug: "what-is-a-plumbing-safety-inspection",
    excerpt: "What a plumbing safety inspection covers, what it costs, and why buyers, sellers, and homeowners in Middlesex County request one before problems turn into emergencies.",
    category: "Safety",
    date: "July 2026",
    image: "",
    readTime: "9 min read",
  ...
  {
    title: "Radiant Floor Heating vs Forced Air: Which Is Better in 2026?",
    slug: "radiant-floor-heating-vs-forced-air",
    excerpt: "Compare radiant floor heating and forced air on comfort, running cost, efficiency, and installation complexity to find the right system for your home.",
    category: "Renovations",
    date: "July 2026",
    image: "/images/radiator-pipe-repair-service.jpg",
    readTime: "12 min read",
  },
  {
    title: "The Complete Guide to Commercial Plumbing Code Compliance",
    slug: "commercial-plumbing-code-compliance-guide",
    excerpt: "Grease traps, backflow prevention, ADA fixtures, and permit inspections: what New Jersey business owners need to know to keep a commercial property code-compliant.",
    category: "Guides",
    date: "July 2026",
    image: "",
    readTime: "11 min read",
  },
  {
    ...
    slug: "basement-flood-prevention-checklist",
    excerpt: "Test your sump pump, check the battery backup, and clear the discharge line before the next storm. The full pre-season walkthrough our plumbers use on service calls.",
  ...
  },
  {
    ...
    slug: "plumbing-for-55-plus-community-downsizing",
    excerpt: "Curbless showers, comfort-height toilets, and grab bars: the plumbing considerations that make a bathroom safer and more comfortable when downsizing to an active-adult community.",
    category: "Renovations",
    date: "July 2026",
    image: "/images/shower-pan-waterproofing-install.jpg",
    readTime: "9 min read",
  },
  {
    title: "What Actually Drives Bathroom Remodel Cost (2026)",
    slug: "what-drives-bathroom-remodel-cost",
    excerpt: "Fixture quality, plumbing relocation, and waterproofing scope drive bathroom remodel cost more than square footage alone. Here is what really moves the price.",
    category: "Renovations",
    date: "July 2026",
  ...
  },
  {
    ...
    slug: "how-often-do-you-need-backflow-testing",
    excerpt: "Most backflow devices need testing once a year, anchored to your install date, not the calendar. What triggers an off-cycle test and what happens if you miss the deadline.",
