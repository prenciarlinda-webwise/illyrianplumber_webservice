...
export const metadata: Metadata = {
  title: "Plumber South Brunswick NJ - Illyrian Group Corp",
  description: "Licensed plumber in South Brunswick, NJ. Water heaters, boilers, gas lines, repiping, and emergency plumbing. Serving all South Brunswick areas. Call (347) 461-4856.",
  keywords: [
    "plumber south brunswick nj",
    "south brunswick plumber",
    "plumbing services south brunswick",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl">
              Professional plumbing services in South Brunswick, NJ. Serving Kendall Park, Monmouth Junction, Dayton, Kingston, and all South Brunswick neighborhoods.
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Areas of South Brunswick We Serve</h2>
            <p className="text-lg text-gray-600 mb-6">
              We provide plumbing services throughout South Brunswick including Kendall Park, Monmouth Junction, Dayton, Kingston, Deans, and all neighborhoods along Route 1 and Route 130.
            </p>
