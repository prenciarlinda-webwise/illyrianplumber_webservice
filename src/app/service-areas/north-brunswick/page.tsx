...
export const metadata: Metadata = {
  title: "Plumber North Brunswick NJ - Illyrian Group Corp",
  description: "Licensed plumber in North Brunswick, NJ. Water heaters, boilers, gas lines, repiping, and emergency plumbing. Fast service from nearby East Brunswick. Call (347) 461-4856.",
  keywords: [
    "plumber north brunswick nj",
    "north brunswick plumber",
    "plumbing services north brunswick",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl">
              Professional plumbing services in North Brunswick, NJ. Serving all North Brunswick neighborhoods with expert plumbing repair, installation, and emergency services.
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Areas of North Brunswick We Serve</h2>
            <p className="text-lg text-gray-600 mb-6">
              We provide plumbing services throughout North Brunswick including areas near Rutgers, along Route 1, Route 130, and all residential neighborhoods.
            </p>
