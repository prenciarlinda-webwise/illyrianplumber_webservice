...
{ source: '/sitemap_index.xml', destination: '/sitemap.xml', permanent: true },
      ...
      { source: '/water-line-repair', destination: '/services/whole-house-repiping', permanent: true },
      { source: '/services/sewer-line-repair-replacement', destination: '/services', permanent: true },
